...
const ProjectCard = ({ 
  ...
  mediaInputRefs: React.MutableRefObject<{ [key: string]: HTMLInputElement | null }>;
}) => (
  <div className="border border-gray-200 rounded-lg p-6 space-y-4">
    ...
    <div>
      ...
      <div 
        className="border-2 border-dashed border-gray-300 rounded-lg p-4 text-center hover:border-[#253E44]/50 transition-colors cursor-pointer"
        onDragOver={(e) => {
          e.preventDefault();
          e.stopPropagation();
        ...
        onDrop={(e) => {
          ...
          e.stopPropagation();
          e.currentTarget.classList.remove('border-blue-500', 'bg-blue-50');
          console.log(`Media files dropped for project ${project.id}:`, e.dataTransfer.files);
      ...
      >
        ...
        <label htmlFor={`media-${project.id}`} className="cursor-pointer block">
          ...
          <div className="text-xs text-gray-400">Click to select or drag multiple files - JPG, PNG, MP4 up to 10MB each</div>
        </label>
      </div>
