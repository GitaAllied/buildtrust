  ...
  useEffect(() => {
    const fetchDeveloperData = async () => {
      ...
      try {
        ...
        // Normalize documents_verified to a number and keep backward-compatible `is_verified`
        payload.documents_verified = Number(payload.documents_verified ?? payload.documentsVerified ?? 0);
        payload.is_verified = Number(payload.documents_verified) === 1;
            ...
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
              <div className="flex-1">
                <div className="flex items-center space-x-3 mb-2">
                  ...
                  {Number(developer.documents_verified) === 1 && (
                ...
                <div className="grid md:grid-cols-3 gap-4">
                  <div className="p-4 bg-green-50 rounded-lg border border-green-200">
                    ...
                    <p className="text-xs text-green-700">
                      {Number(developer.documents_verified) === 1 ? 'Identity and credentials verified' : 'Pending verification'}
                    </p>
                  </div>
