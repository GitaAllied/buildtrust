...
const ProjectImageCarousel = ({ project }: any) => {
  ...
  return (
    ...
    >
      ...
      {mediaArray.length > 1 && (
        <div
          className={`absolute bottom-2 left-1/2 transform -translate-x-1/2 flex gap-1.5 px-2 py-1 bg-black/40 rounded-full transition-opacity duration-300 ${showPagination ? "opacity-100" : "opacity-0"}`}
        >
...
const DeveloperProfile = () => {
    ...
    projects: [
      {
        ...
        budget: "₦15.5M",
        description:
          "A stunning 4-bedroom modern duplex with contemporary design, featuring spacious living areas and high-end finishes.",
        image:
      ...
      },
      {
        ...
        budget: "₦45.2M",
        description:
          "Large-scale commercial plaza with retail spaces, restaurants, and office suites. Modern architectural design with sustainable features.",
        image:
      ...
      },
      {
        ...
        budget: "₦120M",
        description:
          "Exclusive gated residential estate featuring 12 luxury villas with premium amenities including swimming pools, gardens, and 24/7 security.",
        image:
          "https://images.unsplash.com/photo-1570129477992-45a003ff3271?w=500&h=400&fit=crop",
        media: [
          {
            url: "https://images.unsplash.com/photo-1570129477992-45a003ff3271?w=500&h=400&fit=crop",
          },
      ...
      },
      {
        ...
        budget: "₦75.8M",
        description:
          "State-of-the-art office complex with modern facilities, parking, and business amenities. Green building standards applied.",
        image:
    ...
    reviews: [
      {
        ...
        rating: 5,
        comment:
          "Excellent work on our duplex. The team was professional and delivered on time. Highly recommended!",
        date: "2024-12-15",
      },
      {
        id: 2,
        ...
        rating: 5,
        comment:
          "Outstanding quality and attention to detail. Our commercial space is exactly what we envisioned.",
        date: "2024-11-20",
      },
      {
        id: 3,
        ...
        rating: 4,
        comment:
          "Very professional team. Communication was clear throughout the project. Great value for money.",
        date: "2024-10-30",
      },
    ],
  };
      ...
      try {
        ...
        if (payload?.projects && Array.isArray(payload.projects)) {
          payload.projects = payload.projects.map((project: any) => {
            ...
            console.log(
              `📍 Project: ${project.title}, Location:`,
              project.location,
              "City:",
              project.city,
            );
  ...
  const citiesCovered: string[] = (() => {
    if (!developer) return [];
    const raw =
      developer.cities_covered ??
      developer.citiesCovered ??
      developer.citiesServed ??
      developer.preferred_cities ??
      developer.cities_served;
    if (!raw) return [];
            ...
            <Alert variant="destructive">
              ...
              >
                <path
                  ...
                  strokeLinejoin="round"
                  strokeWidth={2}
                  d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m4-2a9 9 0 11-18 0 9 9 0 0118 0z"
                />
              </svg>
              <div>
                ...
                <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
                  <div className="flex-1">
                    ...
                    <p className="text-lg text-gray-600 mb-4">
                      {developer.contact_person || "Developer"}
                    </p>
                    <div className="flex flex-wrap items-center gap-6 text-sm text-gray-600">
                      ...
                      <div className="flex items-center">
                        ...
                        {developer.completed_projects || 0} projects)
                      </div>
                    ...
                    <div className=" flex items-center">
                      <Button
                        onClick={() => {
                          ...
                          if (!token) {
                            setRequestError(
                              "Please log in before requesting a build.",
                            );
                            return;
                          }
                          // Check role
                          try {
                            ...
                            if (role === "developer") {
                              setRequestError(
                                "Only logged-in clients can request to build. Please switch to a client account or contact support for assistance.",
                              );
                              return;
                            }
                          } catch (e) {
                        ...
                        className="bg-[#253E44] hover:bg-[#253E44]/70 text-lg px-8 py-3 h-auto border border-[#253E44] hover:border-opacity-70"
                      >
                        Request to Build
                      </Button>
                      ...
                      <Button
                        ...
                        disabled={isSaving}
                        className={`ml-3 border ${isSaved ? "bg-red-500 hover:bg-red-600 text-white" : "border-gray-300 bg-transparent text-black hover:bg-[#253E44]/10"} text-lg px-5 md:px-8 py-[18px] md:py-3 h-auto flex items-center`}
                      >
                        <Heart
                          className={` text-xl ${isSaved ? "fill-white" : ""}`}
                        />
                        <p className=" hidden md:block">{isSaving ? "Saving..." : isSaved ? "Saved" : "Save"}</p>
                      </Button>
                      )}
                    </div>
              ...
              <TabsContent value="overview" className="space-y-6">
                  ...
                  <CardContent className="space-y-6">
                    ...
                    <div>
                      <p className="text-gray-700 leading-relaxed text-base">
                        {developer.bio ||
                          "This developer has not yet provided a bio. Contact them to learn more about their experience and expertise."}
                      </p>
                    </div>
                    ...
                    <div className="grid md:grid-cols-4 gap-4 p-4 bg-gray-50 rounded-lg">
                      <div className="text-center">
                        <div className="text-2xl font-bold text-[#226F75]">
                ...
                <div className="grid lg:grid-cols-2 gap-6">
                  ...
                  {developer.build_types &&
                    developer.build_types.length > 0 && (
                      <Card>
                        <CardHeader>
                        ...
                        <CardContent>
                          <p className="text-sm text-gray-600 mb-4">
                            This developer specializes in the following project
                            types:
                          </p>
                          <div className="flex flex-wrap gap-2">
                            {developer.build_types.map(
                              (type: any, idx: number) => (
                                <span
                                  key={idx}
                ...
                {citiesCovered.length > 0 && (
                  <Card>
                    ...
                    <CardContent>
                      <p className="text-sm text-gray-600 mb-4">
                        This developer is available to serve clients in the
                        following cities:
                      </p>
                      <div className="flex flex-wrap gap-2">
                    ...
                    <div className="grid md:grid-cols-3 gap-4">
                      ...
                      <div className="p-4 bg-purple-50 rounded-lg border border-purple-200">
                        ...
                        <p className="text-xs text-purple-700">
                          {developer.rating || "0"}/5 stars from verified
                          clients
                        </p>
                      </div>
                    </div>
                  ...
                  {(() => {
                    ...
                    return expected.map((item) => {
                      const found = docs.find(
                        (d) =>
                          (d.type || "").toLowerCase() === item.key ||
                          (d.filename || "").toLowerCase().includes(item.key),
                      );
                      const submitted = !!found;
                      const verified = !!(
                        found &&
                        (found.verified === 1 || found.verified === true)
                      );
                          ...
                          <CardContent className="p-4">
                            ...
                            <div className="mt-3">
                              {verified ? (
                                ...
                                <div className="inline-flex items-center text-xs text-yellow-600">
                                  Pending verification
                                </div>
                              ) : (
                        ...
                        <CardContent className="p-6">
                          <div className="flex items-start justify-between mb-4">
                            <div>
                              ...
                              <p className="text-sm text-gray-600">
                                {review.project_title || "Project"} •{" "}
                                {review.review_date || "Recently"}
                              </p>
                            </div>
                            <div className="flex items-center">
                              {[...Array(5)].map((_, i) => (
