            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-4">
              <div className="flex items-center gap-2 sm:gap-4 w-full sm:w-auto min-w-0">
                ...
                <div className="min-w-0">
                  <h1 className="text-base sm:text-lg md:text-2xl font-bold text-gray-900 truncate">Welcome back, {user?.name || "Developer"}</h1>
                  <div className="flex items-center gap-2 flex-wrap mt-1">
                    <span className="text-xs sm:text-sm text-gray-500">Trust Score:</span>
                    <Progress value={92} className="w-12 sm:w-16 md:w-20 h-2" />
                    <span className="text-xs sm:text-sm font-medium text-green-600">92%</span>
                  </div>
                </div>
              </div>
            ...
            <div className="lg:col-span-2 space-y-3 sm:space-y-4 md:space-y-6">
              ...
              <div>
                <div className="flex items-center justify-between mb-3 px-1">
                  <h2 className="text-sm sm:text-base md:text-lg font-semibold">Incoming Project Requests</h2>
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3 sm:gap-4">
                          <div className="flex-1 min-w-0">
                            <div className="flex items-center gap-2 mb-2 flex-wrap">
                              <h3 className="font-semibold text-xs sm:text-sm md:text-base truncate">{request.project}</h3>
                              <Badge variant="outline" className="text-xs flex-shrink-0">
                                {request.received}
                              </Badge>
                            </div>
                            <p className="text-xs sm:text-sm text-gray-600 mb-1">Client: {request.client}</p>
                            <p className="text-xs sm:text-sm text-gray-600 mb-1">Location: {request.location}</p>
                            <p className="text-xs sm:text-sm text-gray-600 mb-2">Timeline: {request.timeline}</p>
              ...
              {/* Ongoing Projects */}
              <div>
                <h2 className="text-sm sm:text-base md:text-lg font-semibold mb-3 px-1">Ongoing Projects Overview</h2>
                <div className="space-y-3 sm:space-y-4">
                  {ongoingProjects.map((project) => (
                    <Card key={project.id} className="hover:shadow-md transition-shadow">
                      <CardContent className="p-3 sm:p-4 md:p-6">
                        <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3 sm:gap-4">
                          <div className="flex-1 min-w-0">
                            <h3 className="font-semibold text-xs sm:text-sm md:text-base mb-1 truncate">{project.title}</h3>
