...
import { getAllProjects, getAllDevelopers, updateProject } from "@/lib/mockData";
import {
  Search,
  Filter,
  MoreHorizontal,
...
const AdminProjects = () => {
  ...
  const loadProjects = async () => {
    try {
      ...
      const projectsWithNames = response.map((p: any) => ({
        ...
        developer_name: p.developer_name || (p.developer_id ? `Developer ${p.developer_id}` : 'Unassigned'),
      }));
  ...
  const handleAssignDeveloper = async () => {
    ...
    try {
      ...
      updateProject(selectedProject.id, { developer_id: parseInt(selectedDeveloper) });
        ...
        <div className="flex items-center justify-between gap-4">
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">Manage all projects and assignments</p>
            </div>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                  ...
                  {filteredProjects.length === 0 ? (
                    ...
                    filteredProjects.map((project) => (
                      <tr key={project.id} className="border-b border-gray-100 hover:bg-gray-50">
                        ...
                        <td className="py-3 px-4">
                          <Badge variant={project.developer_id ? "secondary" : "outline"}>
        ...
        <Dialog open={isDeveloperDialogOpen} onOpenChange={setIsDeveloperDialogOpen}>
          <DialogContent>
            ...
            <DialogFooter>
              <Button variant="outline" onClick={() => setIsDeveloperDialogOpen(false)}>
                Cancel
              </Button>
              <Button
