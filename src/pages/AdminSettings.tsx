...
const AdminSettings = () => {
  ...
  const [generalSettings, setGeneralSettings] = useState({
    ...
    siteDescription:
      "Connecting verified developers with clients across Africa",
                                  ...
                                  <div className="ml-3">
                                    ...
                                    <div className="mt-2 text-sm text-yellow-700">
                                      <p>
                                        ...
                                        be automatically logged out and will
                                        need to log in again with your new
                                        password. Make sure to remember your new
                                        password or store it securely.
                                      </p>
                                    </div>
                                  </div>
                                </div>
                            ...
                            <CardContent className="space-y-4">
                              <div className="flex items-center justify-between">
                                ...
                                <Switch
                                  ...
                                  checked={
                                    emailSettings.emailVerificationEnabled
                                  }
                                  onCheckedChange={(checked) =>
                                    handleEmailSettingChange(
                              ...
                              <div className="flex items-center justify-between">
                                ...
                                <Switch
                                  ...
                                  checked={
                                    emailSettings.projectNotificationsEnabled
                                  }
                                  onCheckedChange={(checked) =>
                                    handleEmailSettingChange(
                              ...
                              <div className="flex items-center justify-between">
                                ...
                                <Switch
                                  ...
                                  checked={
                                    emailSettings.paymentNotificationsEnabled
                                  }
                                  onCheckedChange={(checked) =>
                                    handleEmailSettingChange(
                              ...
                              <div className="flex items-center justify-between">
                                ...
                                <Switch
                                  ...
                                  checked={
                                    emailSettings.adminNotificationsEnabled
                                  }
                                  onCheckedChange={(checked) =>
                                    handleEmailSettingChange(
                              ...
                              <div className="grid grid-cols-1 sm:grid-cols-4 items-start sm:items-center gap-2 sm:gap-4">
                                ...
                                <div className="col-span-3 relative">
                                  <Input
                                    ...
                                    value={
                                      paymentSettings.flutterwaveEncryptionKey
                                    }
                                    onChange={(e) =>
                                      handlePaymentSettingChange(
                                        "flutterwaveEncryptionKey",
                                  ...
                                  {paymentSettings.autoReleaseEscrow && (
                                    <div className="grid grid-cols-1 sm:grid-cols-4 items-start sm:items-center gap-2 sm:gap-4">
                                      ...
                                      <Input
                                        ...
                                        type="number"
                                        value={
                                          paymentSettings.escrowReleaseDays
                                        }
                                        onChange={(e) =>
                                          handlePaymentSettingChange(
                                            "escrowReleaseDays",
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                  ...
                                  <div className="flex items-center space-x-2">
                                    <Switch
                                      ...
                                      checked={
                                        paymentSettings.disputeResolutionEnabled
                                      }
                                      onCheckedChange={(checked) =>
                                        handlePaymentSettingChange(
